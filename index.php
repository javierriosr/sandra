...
<body>
    ...
    <div class="image-container">
        <img src="images/banner.png" alt="Banner de Sanación Genética">
    </div>
    ...
    <main>
        ...
        <section class="card reveal-on-scroll">
            ...
            <ol>
                <li><i class="bi bi-camera-video-fill"></i> <strong>Programa presencial en vivo</strong></li>
                <li><i class="bi bi-people-fill"></i> <strong>Taller de conductas parentales</strong> y manual de apoyo.
                </li>
                <li><i class="bi bi-magic"></i> <strong>Carta astrológica de tránsitos</strong> con documento
                    interpretativo.</li>
                <li><i class="bi bi-key-fill"></i> <strong>Códigos sagrados</strong> para tu proceso.</li>
                <li><i class="bi bi-yin-yang"></i> <strong>Meditación guiada</strong> para los 21 días de sanación.</li>
                <li><i class="bi bi-person-video3"></i> <strong>Sesión virtual grupal</strong> de seguimiento (1 hora).
                </li>
            </ol>
        </section>
